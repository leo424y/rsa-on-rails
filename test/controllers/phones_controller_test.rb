...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { message: @phone.message, user_id: @phone.user_id } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { message: @phone.message, user_id: @phone.user_id } }
